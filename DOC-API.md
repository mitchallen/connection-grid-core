...
* [connection-grid-core](#module_connection-grid-core) ⇐ <code>[@mitchallen/grid-core](#external_@mitchallen/grid-core)</code>
    ...
    * [.isDeadEnd(x, y)](#module_connection-grid-core+isDeadEnd) ⇒ <code>boolean</code>
...
```
<a name="module_connection-grid-core+isDeadEnd"></a>

### connection-grid-core.isDeadEnd(x, y) ⇒ <code>boolean</code>
