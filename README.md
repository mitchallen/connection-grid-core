> **This repository is archived, and `@mitchallen/connection-grid-core` is frozen at 0.1.28.**
...
> `@mitchallen/connection-grid-core-v2`, an internal package of the
> [maze-generator-v2](https://github.com/mitchallen/maze-generator-v2) monorepo
> ([`packages/connection-grid-core`](https://github.com/mitchallen/maze-generator-v2/tree/main/packages/connection-grid-core)),
> bundled into `@mitchallen/maze-generator-v2`. Version 0.1.28 was published from
...
<p align="left">
  ...
  <a href="https://github.com/mitchallen/connection-grid-core/actions/workflows/ci.yml?query=branch%3Amain">
...
Versions **0.1.22** and earlier remain on npmjs.org and are no longer updated there.
...
<html>
  <head>
    ...
    <script src="https://cdn.jsdelivr.net/gh/mitchallen/connection-grid-core@v0.1.26/dist/connection-grid-core.min.js"></script>
